...
class __TwigTemplate_2d45b156f9a9d19ba31e2513b38ddfa2 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <p>
        The requested page couldn't be located. Checkout for any URL
        misspelling or <a href=\"{{ path('app_accueil') }}\">return to the homepage</a>.
    </p>
{% endblock %}", "@Twig/Exception/error404.html.twig", "/home/stagiaire/Bureau/the_district_symfony/templates/bundles/TwigBundle/Exception/error404.html.twig");
    }
}
