...
class __TwigTemplate_9ee41486be277ce13d4a9aee862d701f extends Template
{
    private $source;
    private $macros = [];
...
{% for css_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_css_assets.html.twig", "/home/stagiaire/Bureau/the_district_symfony/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_css_assets.html.twig");
    }
}
