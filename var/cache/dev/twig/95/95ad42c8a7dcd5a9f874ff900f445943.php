...
class __TwigTemplate_bc5f961b9f5cab37fdf9cff79a5f6f2f extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    events: [ ";
            // line 167
            echo twig_call_macro($macros["__internal_parse_2"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 167, $this->source); })())], 167, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "/home/stagiaire/Bureau/the_district_symfony/vendor/symfony/web-profiler-bundle/Resources/views/Collector/time.html.twig");
    }
}
